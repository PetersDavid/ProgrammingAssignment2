## makeCacheMatrix creates a list contatining a function to
...
## cacheSolve will return the inverse of the matrix. It first checks
## if the inverse has already been computed. if so, it gets the result
## and skips the computation. If not, it computes the inverse, sets the
